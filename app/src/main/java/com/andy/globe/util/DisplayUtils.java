...
public class DisplayUtils {
    ...
    public static int[] getRealScreenSize(Context context) {
        if (DeviceUtils.isEssentialPhone() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static int getUsefulScreenWidth(Activity activity) {
        return getUsefulScreenWidth(activity, NotchUtils.hasNotch(activity));
    }

    public static int getUsefulScreenWidth(View view) {
        return getUsefulScreenWidth(view.getContext(), NotchUtils.hasNotch(view));
    }
    ...
    public static int getUsefulScreenWidth(Context context, boolean hasNotch) {
        ...
        if (isLandscape) {
            ...
            if (DeviceUtils.isHuawei() && !DisplayUtils.huaweiIsNotchSetToShowInSetting(context)) {
                result -= NotchUtils.getNotchSizeInHuawei(context)[1];
            }
    ...
    public static int getUsefulScreenHeight(Activity activity) {
        return getUsefulScreenHeight(activity, NotchUtils.hasNotch(activity));
    }

    public static int getUsefulScreenHeight(View view) {
        return getUsefulScreenHeight(view.getContext(), NotchUtils.hasNotch(view));
    }
